    ...
    try {
      ...
      if (imageFile) {
        ...
        const imageResponse = await axios.post(
          "http://localhost:5002/api/users/upload-profile-image",
          imageData,
          {
            withCredentials: true,
            headers: {
      ...
      await axios.put("http://localhost:5002/api/users/profile", formData, {
        withCredentials: true,
      });
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-0">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-gradient-to-r from-[#5A3E36] to-[#A0522D] text-white p-6 flex items-center justify-between">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={updating}
              className={`px-6 py-2 bg-[#A0522D] text-white rounded-md hover:bg-[#8B4513] transition ${
